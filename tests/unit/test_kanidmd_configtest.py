"""Unit tests for kanidmd_configtest module."""
...
def test_module_compiles():
    ...
    spec = importlib.util.spec_from_file_location("kanidmd_configtest", "plugins/modules/kanidmd_configtest.py")
...
def test_module_returns_doc():
    ...
    assert "status" in module.RETURN or "validated" in module.RETURN
