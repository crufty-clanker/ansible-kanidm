"""Unit tests for kanidmd_vacuum module."""
...
def test_module_compiles():
    ...
    spec = importlib.util.spec_from_file_location("kanidmd_vacuum", "plugins/modules/kanidmd_vacuum.py")
...
def test_module_returns_doc():
    ...
    assert "vacuumed" in module.RETURN or "changed" in module.RETURN
