# kanidm_community.kanidm.kanidm-unixd Role

Install and configure kanidm-unixd for PAM/SSSD integration on Debian-based systems.
...
| `kanidm_unixd_packages` | `["kanidm-unixd", "libnss-kanidm", "libpam-kanidm"]` | APT packages to install |
